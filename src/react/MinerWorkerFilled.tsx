...
const MinerWorkerFilled = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <path fill="currentColor" d="M25 7a1 1 0 1 0-2 0z" />
    <path
      fill="currentColor"
      fillRule="evenodd"
    ...
    <path
      fill="currentColor"
      d="M12 30.425a29 29 0 0 1 2-.717V42h-2zM34 29.708c.687.22 1.357.459 2 .717V42h-2zM10 31.345C7.635 32.597 6 34.167 6 36v6h4zM42 36c0-1.833-1.635-3.404-4-4.655V42h4z"
    />
  </svg>
)
export default MinerWorkerFilled
