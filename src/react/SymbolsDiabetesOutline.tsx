...
const SymbolsDiabetesOutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M37.986 33.424c1.68 0 2.999-1.26 2.998-2.86-.002-1.485-3.005-5.14-3.005-5.14s-2.997 3.546-2.995 5.146c0 1.6 1.322 2.856 3.002 2.854"
    />
  </svg>
)
export default SymbolsDiabetesOutline
