...
const Icon4x4Filled = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M15 39c0-1.06-.474-2.078-1.318-2.828S11.693 35 10.5 35s-2.338.422-3.182 1.172S6 37.939 6 39v2a1 1 0 0 0 1 1h27.5a1 1 0 1 0 0-2H25a2 2 0 0 0-4 0 3 3 0 0 0-6 0zM17.645 28.946l-5.796-1.553-.76 2.835a1 1 0 0 0 .707 1.225l3.864 1.035a1 1 0 0 0 1.225-.707zM28.445 31.886l5.796 1.553-.748 2.792a1 1 0 0 1-1.225.707l-3.864-1.035a1 1 0 0 1-.707-1.225zM20.063 27.07l1.036-3.864 2.516.675-1.128 3.839zM24.42 28.238l1.127-3.84 2.313.62-1.035 3.864z"
    />
  </svg>
)
export default Icon4x4Filled
