...
const FruitsOutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M37.845 18.09a4.5 4.5 0 0 1 2.716 5.755 1 1 0 1 1-1.883-.675 2.5 2.5 0 1 0-4.706-1.69 1 1 0 1 1-1.882-.675 4.5 4.5 0 0 1 5.755-2.715"
      clipRule="evenodd"
    />
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M36.253 23.176a4.501 4.501 0 0 1 3.822 8.014 1 1 0 0 1-1.144-1.64 2.5 2.5 0 1 0-3.008-3.99 1 1 0 1 1-1.262-1.552 4.5 4.5 0 0 1 1.592-.832M27.78 29a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5m-4.5 2.5a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0"
      clipRule="evenodd"
    />
    <path
      fill="currentColor"
    ...
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M37.834 33.966a1 1 0 0 1 1.278-.606 4.5 4.5 0 1 1-4.675 7.44 1 1 0 1 1 1.405-1.423 2.5 2.5 0 1 0 2.598-4.133 1 1 0 0 1-.606-1.279"
      clipRule="evenodd"
    />
  </svg>
)
export default FruitsOutline
