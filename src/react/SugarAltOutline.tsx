...
const SugarAltOutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M5 22h2v2H5zM13 22h2v2h-2zM10 21.586 11.414 23 10 24.414 8.586 23zM18 21.586 19.414 23 18 24.414 16.586 23zM11 18h2v2h-2zM8 17.586 9.414 19 8 20.414 6.586 19zM12 13.586 13.414 15 12 16.414 10.586 15zM16 17.586 17.414 19 16 20.414 14.586 19z"
    />
  </svg>
)
export default SugarAltOutline
