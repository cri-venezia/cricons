...
const CervicalCancerFilled = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="currentColor"
      d="M22.72 11.4c-.05 0-.1.021-.135.059a1.35 1.35 0 0 0-.045 1.792L24 14.955l1.46-1.704a1.35 1.35 0 0 0-.044-1.792.19.19 0 0 0-.136-.059z"
    />
    <path
      fill="currentColor"
      fillRule="evenodd"
...
export default CervicalCancerFilled
