...
const NurseOutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path fill="currentColor" d="M27 13v-2h-2V9h-2v2h-2v2h2v2h2v-2z" />
    <path
      fill="currentColor"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <path fill="currentColor" d="M34 34h2v2h-2v2h-2v-2h-2v-2h2v-2h2z" />
    <path
      fill="currentColor"
      fillRule="evenodd"
