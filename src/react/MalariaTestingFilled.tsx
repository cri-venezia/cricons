...
const MalariaTestingFilled = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M12 26h-2a1 1 0 1 0 0 2h2zM14 28h3v-2h-3zM19 28h3v-2h-3zM26 26a1 1 0 1 1 0 2h-2v-2z"
    />
    <path
      fill="currentColor"
      fillRule="evenodd"
    ...
    <path
      fill="currentColor"
      d="M7.85 14.105c.238-.105.495-.131.743-.079s.485.185.677.39a1 1 0 0 0 1.46-1.368 3.3 3.3 0 0 0-1.722-.978 3.2 3.2 0 0 0-1.966.206 3.4 3.4 0 0 0-1.495 1.304A3.6 3.6 0 0 0 5 15.5c0 .678.188 1.346.547 1.92s.877 1.031 1.495 1.304a3.2 3.2 0 0 0 1.966.206 3.3 3.3 0 0 0 1.722-.978 1 1 0 1 0-1.46-1.368c-.192.205-.43.337-.677.39a1.2 1.2 0 0 1-.742-.079 1.4 1.4 0 0 1-.609-.537A1.6 1.6 0 0 1 7 15.5c0-.31.087-.61.242-.858.156-.248.37-.432.609-.537"
    />
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M13 36a1 1 0 0 1 1-1h2.5a2.5 2.5 0 0 1 0 5H15v1a1 1 0 1 1-2 0zm2 2h1.5a.5.5 0 0 0 0-1H15zM34 12a1 1 0 0 0-1 1v5a1 1 0 1 0 2 0v-1h1.5a2.5 2.5 0 0 0 0-5zm2.5 3H35v-1h1.5a.5.5 0 0 1 0 1"
      clipRule="evenodd"
    />
    <path
      fill="currentColor"
      d="M22.5 42a1 1 0 0 0 .936-.649l1.5-4a1 1 0 1 0-1.872-.702l-.564 1.503-.564-1.503a1 1 0 0 0-1.872.702l1.5 4A1 1 0 0 0 22.5 42M42 18v-2a1 1 0 0 0 0-2 1 1 0 0 0 0-2c-.726 0-1.276.325-1.611.79A2.1 2.1 0 0 0 40 14a1 1 0 1 0 0 2v2a1 1 0 1 0 2 0"
    />
  </svg>
)
export default MalariaTestingFilled
