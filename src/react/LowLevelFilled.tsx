...
const LowLevelFilled = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M25.632 36.499a1.6 1.6 0 0 1-1.14.07l-12.926-5.433c-1.913-.592-1.437-2.56.54-2.25l13.984.801c.388.061.741.262.992.565l1.72 2.372c.264 1.03.151 1.517-.581 2.502z"
    />
  </svg>
)
export default LowLevelFilled
