...
const ArtificialIntelligenceFilled = (props: SvgProps) => (
  ...
  >
    ...
    />
    <Path
      d="M20 14C17.6054 22.6512 14.5237 25.6076 6 28C14.5237 30.3924 17.6054 33.3488 20 42C22.3946 33.3488 25.4763 30.3924 34 28C25.4763 25.6076 22.3946 22.6512 20 14Z"
      fill="currentColor"
    />
  </Svg>
)
export default ArtificialIntelligenceFilled
