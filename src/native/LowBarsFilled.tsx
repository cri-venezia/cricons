...
const LowBarsFilled = (props: SvgProps) => (
  <Svg viewBox="0 0 48 48" fill="none" width={24} height={24} {...props}>
    <Path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M35 6C33.3431 6 32 7.34315 32 9V39C32 40.6569 33.3431 42 35 42H39C40.6569 42 42 40.6569 42 39V9C42 7.34315 40.6569 6 39 6H35ZM34 9C34 8.44772 34.4477 8 35 8H39C39.5523 8 40 8.44772 40 9V39C40 39.5523 39.5523 40 39 40H35C34.4477 40 34 39.5523 34 39V9Z"
      fill="currentColor"
    />
    <Path
      fillRule="evenodd"
