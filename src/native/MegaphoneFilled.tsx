...
const MegaphoneFilled = (props: SvgProps) => (
  <Svg
    viewBox="0 0 48 48"
    fill="none"
  ...
  >
    ...
    />
    <Path
      d="M18 30V15L27.4631 8.97801C28.1288 8.55437 29 9.03258 29 9.82167V35.1783C29 35.9674 28.1288 36.4456 27.4631 36.022L18 30Z"
      fill="currentColor"
    />
    <Path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M40.8322 17.4453C41.1385 17.9048 41.0143 18.5257 40.5548 18.832L37.5548 20.8321C37.0953 21.1384 36.4744 21.0142 36.1681 20.5547C35.8617 20.0952 35.9859 19.4743 36.4454 19.1679L39.4454 17.1679C39.9049 16.8616 40.5258 16.9858 40.8322 17.4453ZM36.0001 24C36.0001 23.4477 36.4478 23 37.0001 23H41.0001C41.5524 23 42.0001 23.4477 42.0001 24C42.0001 24.5523 41.5524 25 41.0001 25H37.0001C36.4478 25 36.0001 24.5523 36.0001 24ZM36.1681 27.4453C36.4744 26.9858 37.0953 26.8616 37.5548 27.1679L40.5548 29.168C41.0143 29.4743 41.1385 30.0952 40.8322 30.5547C40.5258 31.0142 39.9049 31.1384 39.4454 30.8321L36.4454 28.8321C35.9859 28.5257 35.8617 27.9048 36.1681 27.4453Z"
      fill="currentColor"
    />
  </Svg>
)
