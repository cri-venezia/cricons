...
const BlisterPillsOvalX1Outline = (props: SvgProps) => (
  <Svg viewBox="0 0 48 48" fill="none" width={24} height={24} {...props}>
    ...
    />
    <Path
      d="M23 24C23 24.5523 22.5523 25 22 25C21.4477 25 21 24.5523 21 24C21 23.4477 21.4477 23 22 23C22.5523 23 23 23.4477 23 24Z"
      fill="currentColor"
    />
    <Path
      d="M26 25C26.5523 25 27 24.5523 27 24C27 23.4477 26.5523 23 26 23C25.4477 23 25 23.4477 25 24C25 24.5523 25.4477 25 26 25Z"
      fill="currentColor"
    />
    <Path
      d="M31 24C31 24.5523 30.5523 25 30 25C29.4477 25 29 24.5523 29 24C29 23.4477 29.4477 23 30 23C30.5523 23 31 23.4477 31 24Z"
      fill="currentColor"
    />
    <Path
      fillRule="evenodd"
